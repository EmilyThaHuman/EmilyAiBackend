const userPrompts = {
  UI_ANALYSIS_FROM_IMAGE:
    "Generate a prompt for a component generator UI which gives a precisely accurate analysis of the the component in the image and providers all details necessary for replicating the exact same component"
};
const initialUserPrompts = [
  ...
  },
  {
    ...
    content:
      "How do I create a responsive grid layout in Material-UI that adapts to different screen sizes?",
    role: "user",
    type: "layout",
    sharing: "public",
    rating: 4.8,
  ...
  },
  {
    ...
    content:
      "What are some best practices for optimizing the performance of large React components?",
    role: "frontend",
    type: "performance",
    sharing: "public",
    rating: 4.6,
