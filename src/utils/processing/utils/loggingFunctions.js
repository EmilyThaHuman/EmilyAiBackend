...
/**
 * Logs an array of objects as a formatted table in the console.
...
/**
 * Records token usage data for prompt, completion, and total tokens.
 * @param {Object} options - The token usage data object.
