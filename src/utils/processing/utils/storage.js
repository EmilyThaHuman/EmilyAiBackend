...
/**
 * Uploads a file to a specified location based on user ID and file ID.
 ...
 * @returns {string} The file path where the uploaded file is stored.
...
/**
 * Deletes a file from storage synchronously
...
/**
 * Generates a signed URL for file download using JWT
 ...
 * @param {string} options.name - The name of the file to be saved.
 * @returns {string} The destination path where the file was saved.
